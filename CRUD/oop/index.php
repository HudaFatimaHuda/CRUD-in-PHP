<?php
    ...
    if(isset($_POST['submit']) && !isset($_GET['id'])) {
        ...
        if($result === true){
            ...
            echo "Sorry! Create operation cannot be completed. " . $result;
        }
    }
                ...
                <div class="modal-body">
                    <form id='add-user' autocomplete="off" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="p-2 my-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" class="form-control" name="name" required pattern="[a-zA-Z ]*">
                            <p class="text-danger"><?php if(isset($nameError)){echo $nameError;} ?></p>
                        </div>
                        <div class="mb-3">
                            <label for="score" class="form-label">Score</label>
                            <input type="number" id="score" class="form-control" name="score" required  min=0 max=100>
                            <p class="text-danger"><?php if(isset($scoreError)){echo $scoreError;} ?></p>
                        </div>
