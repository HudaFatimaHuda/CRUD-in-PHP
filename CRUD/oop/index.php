<?php
    ...
    if(isset($_POST['submit']) && !isset($_GET['id'])) {
        $result = $operation->addRecord($_POST);
        if($result === true){
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id='add-user' autocomplete="off" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="p-2 my-2" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" id="img" class="form-control" name="img" value="" accept="image/*" required>
                        </div>
